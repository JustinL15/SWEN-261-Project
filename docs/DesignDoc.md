...
The customer model allows representing a customer and tying them to their cart and all existing orders. It also holds a password to allow login information.
